...
# Titulo.
labelAlgoritmo = CTkLabel(root, text="ALGORITMO POR PROFUNDIDAD", fg_color="#7c149c", text_color="black", anchor="center", height=50, width=50, font=("Georgia", 32, "bold"))
...
def estadisticas():
    ...
    tiempoR = "{:.3f}".format(tiempo_total)
