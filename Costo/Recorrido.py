...
# Busca y extrae el nodo con el menor costo de la cola de nodos.
def obtenerNodoMenorCosto():
    # Crear un heap basado en la cola de nodos y la función de comparación de costo
    heapq.heapify(cola)
    # Sacar el nodo con menor costo del heap
    nodo_menor_costo = heapq.heappop(cola)
...
def expandirNodos ():
    ...
    while cola:
        ...
        padreExpandido = obtenerNodoMenorCosto()
