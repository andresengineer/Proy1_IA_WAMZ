...
def getHeuristicaMasCosto():
    menor_heuristica_mas_costo = min(cola, key=lambda x: x.get_heuristicaCosto())
    return cola.pop(cola.index(menor_heuristica_mas_costo))
...
def expandirNodos ():
    ...
    while cola:
        ...
        padreExpandido = getHeuristicaMasCosto()
